...
db_path = Path("C:/Users/Sweet/OneDrive/Documents/GitHub/sqlalchemy-challenge/Resources/hawaii[1].sqlite")
engine = create_engineengine = create_engine(f"sqlite:///{db_path}")
